          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Tổng đơn</p>
                    <h5 class="font-weight-bolder mb-0">
                      100
        ...
        <div class="col-lg-5 mb-lg-0 mb-4">
          <div class="card">
            <div class="card-body p-3">
              ...
              <p class="text-sm ms-2"> Hơn (<span class="font-weight-bolder">+23%</span>) so với tháng trước</p>
                ...
                <div class="row">
                  ...
                  <div class="col-4 py-3 ps-0">
                    <div class="d-flex mb-2">
                      ...
                      <p class="text-xs mt-1 mb-0 font-weight-bold">Xem</p>
                    </div>
                  ...
                  <div class="col-4 py-3 ps-0">
                    <div class="d-flex mb-2">
                      ...
                      <p class="text-xs mt-1 mb-0 font-weight-bold">Sản phẩm</p>
                    </div>
          ...
          <div class="card">
            <div class="card-header pb-0">
              ...
              <p class="text-sm">
                ...
                <span class="font-weight-bold">hơn 4%</span> so với tháng trước
              </p>
            </div>
            <div class="card-body p-3">
              <div class="chart">
